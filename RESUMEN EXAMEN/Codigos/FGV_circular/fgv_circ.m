% fgv_circ.m â€” script principal de FLUJO GRADUALMENTE VARIADO (FGV) en
% conducto/canal CIRCULAR (p.ej. caÃ±o de alcantarillado que no trabaja a
% presiÃ³n): calcula yc (crÃ­tico, por fzero) y el/los yn (normal(es) â€”
...
% (cruce de yc, o llegar a secciÃ³n llena y=d, o y=0), y grafica el
...
% borde (x_ini,x_end,y_ini) segÃºn el enunciado.
% Usar cuando: piden el perfil y(x) de un caÃ±o/conducto circular
