% circ.m â€” ecuaciÃ³n diferencial dy/dx del FGV para CONDUCTO/CANAL
% CIRCULAR (usa la geometrÃ­a circular inline). Se pasa como function
% handle a ode23 dentro de fgv_circ.m: par=[Q,d,S,n]. Entradas: x
% (posiciÃ³n, muda), y (tirante), par. Salida: dydx = pendiente de la
% superficie libre.
