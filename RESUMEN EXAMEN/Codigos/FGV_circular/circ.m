% circ.m — ecuación diferencial dy/dx del FGV para CONDUCTO/CANAL
% CIRCULAR (usa la geometría circular inline). Se pasa como function
% handle a ode23 dentro de fgv_circ.m: par=[Q,d,S,n]. Entradas: x
% (posición, muda), y (tirante), par. Salida: dydx = pendiente de la
% superficie libre.
