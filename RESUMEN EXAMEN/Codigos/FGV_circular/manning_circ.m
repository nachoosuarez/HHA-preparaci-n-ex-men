% manning_circ.m — función auxiliar de error (Q_Manning(y) - Q) para un
% conducto CIRCULAR parcialmente lleno, con vector de parámetros
...
% inline, no lo llama por nombre pero replica su cálculo).
function en = manning_circ(y,par)
%% Datos de entrada
Q = par(1);% caudal en m3/s
d = par(2);% di�metro en m
