% conjugados_trap.m — dado un momento M, devuelve los DOS tirantes
% conjugados (yconj1, yconj2) de un canal trapezoidal, iterando con
% fsolve. Complementa a Mom_trap.m (que parte de un tirante conocido en
% vez del momento). Entradas: b (ancho fondo), m (talud), Q (caudal), M
% (momento). Salidas: yconj1, yconj2 (tirantes conjugados). Usar cuando:
% se conoce M de antemano y se piden ambos tirantes conjugados de un
% RESALTO HIDRÁULICO. Requiere trap_geom.m y Mom_trap.m.
