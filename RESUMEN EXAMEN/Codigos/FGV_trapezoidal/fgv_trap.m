% fgv_trap.m â€” script principal de FLUJO GRADUALMENTE VARIADO (FGV) en
% canal TRAPEZOIDAL: calcula yc (crÃ­tico) y yn (normal), integra la
% ecuaciÃ³n diferencial dy/dx (funciÃ³n rect.m, pese al nombre) con
% ode23 deteniÃ©ndose al cruzar yc (evento critico.m), grafica el perfil
...
% condiciones de borde (x_ini,x_end,y_ini) segÃºn el enunciado â€” el signo
% de x_end define si se integra hacia aguas arriba (subcrÃ­tico) o hacia
% aguas abajo (supercrÃ­tico); ver comentario "NOTA" en el propio script.
...
% nombres de la versiÃ³n rectangular por error de copia/pegado â€” los
