% tirantes_yn_yc.m â€” atajo que calcula juntos el tirante normal yn
% (Manning) y el tirante crÃ­tico yc de un canal trapezoidal, resolviendo
% eq_yn.m y eq_yc.m con fsolve a partir de una estimaciÃ³n inicial fija
