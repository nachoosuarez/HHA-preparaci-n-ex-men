% Eesp_trap.m â€” calcula la energÃ­a especÃ­fica E de un canal trapezoidal
% para un tirante y dado, y busca por iteraciÃ³n (fsolve) su tirante
% ALTERNO yalt (misma E, distinta rama del flujo, sub vs supercrÃ­tico).
...
% (talud 1V:mH). Salidas: E (energÃ­a especÃ­fica, m), yalt (tirante
% alterno). Usar cuando: transiciÃ³n con ENERGÃA CONSTANTE (escalÃ³n de
% fondo, contracciÃ³n/expansiÃ³n suave, compuerta sin pÃ©rdidas) â€” ver
% tambiÃ©n alternos_trap.m. Requiere trap_geom.m.
