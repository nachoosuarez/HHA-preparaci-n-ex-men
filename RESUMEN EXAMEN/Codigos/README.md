...
|---|---|---|
| `Bombas/` | `Bomba_sola.m`, `Bombas_serie.m`, `Bombas_paralelo.m`, `Bombas_LineasDeCarga.m`, `Bomba_curvaInstalacion.m`, `colebrook.m` | Sistemas de bombeo (succión + impulsión): punto de funcionamiento de una bomba sola, dos bombas en serie o en paralelo, línea de carga/piezométrica de la instalación, y gráfico comparativo curva de instalación vs. curva de catálogo. |
