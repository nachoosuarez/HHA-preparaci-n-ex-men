...
|---|---|---|
| `Bombas/` | `Bomba_sola.m`, `Bombas_serie.m`, `Bombas_paralelo.m`, `Bombas_LineasDeCarga.m`, `Bomba_curvaInstalacion.m`, `Bomba_manometros.m`, `colebrook.m` | Sistemas de bombeo (succión + impulsión): punto de funcionamiento de una bomba sola, dos bombas en serie o en paralelo, línea de carga/piezométrica de la instalación, gráfico comparativo curva de instalación vs. curva de catálogo, y punto de funcionamiento/NPSH cuando el dato son lecturas directas de manómetros en las bridas de la bomba (`Bomba_manometros.m`, sin necesidad de calcular pérdidas de tubería). |
