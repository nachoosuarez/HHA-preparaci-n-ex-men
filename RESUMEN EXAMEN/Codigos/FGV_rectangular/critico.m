...
% de la ecuación diferencial de FGV (rect.m/fgv_rect.m) apenas el
...
% Requiere que par traiga yc en la 5ta posición: par=[Q b S n yc].
% (misma función que la de FGV_trapezoidal, reutilizada tal cual).
