% Bombas_paralelo.m â€” calcula el punto de funcionamiento de DOS bombas
% iguales o distintas conectadas en PARALELO (mismo H, caudales Q1+Q2 se
% suman) contra una instalaciÃ³n con succiÃ³n + impulsiÃ³n.
% Entradas: geometrÃ­a de succiÃ³n/impulsiÃ³n (L,D,z,p,k,epsilon), y curvas
% de catÃ¡logo Q1,H1,eta1,NPSHr1 y Q2,H2,eta2,NPSHr2 de cada bomba.
% Salidas: grÃ¡fico H-Q (bombas individuales, curva paralelo equivalente,
% instalaciÃ³n), punto de funcionamiento, chequeo de cavitaciÃ³n (NPSHdisp
