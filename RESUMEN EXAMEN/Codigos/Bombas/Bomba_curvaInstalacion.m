% Bomba_curvaInstalacion.m — grafica la curva de instalación H(Q) junto
% con la curva característica H-Q de la bomba (dato de catálogo, tabla
% Qb/Hb), la curva de NPSH disponible, la curva de NPSH requerido y la
% curva de eficiencia, marcando el/los caudal(es) de interés (p.ej. el
% punto de funcionamiento ya hallado por otro método).
% Entradas: geometría de succión/impulsión (L,D,z,epsilon), tablas de
% catálogo de la bomba (Qb,Hb; Qn,Hn eficiencia; Q_NPSHrec,NPSHrec) y el
% caudal de funcionamiento ya calculado (Qpf,Hpf) a marcar en el gráfico.
% Usar cuando: ya se conoce (o se supone) el punto de funcionamiento y
% sólo hace falta el gráfico comparativo de curvas de instalación,
% bomba, eficiencia y NPSH sobre un mismo eje. Requiere colebrook.m.
clc; clear; close all;
