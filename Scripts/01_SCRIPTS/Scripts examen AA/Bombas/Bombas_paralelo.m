...
Ds = 0.2; %metros
z1 = 0; %metros
ks = 2.3; %coeficiente de perdida de carga localizada (suma de todas la perdidas de carga loc)
...
%Li2 = 850; %metros
%Di2 = 0.25; %metros
ki = 1.3; %coeficiente de perdida de carga localizada
z2 = 20; %metros
p2 = 0; %SI ES TANQUE O CAIDA LIBRE ES 0

% Bomba 1
%PASAR EL Q A M3/S (dividido 1000)
Q1 = [0.0001 0.0078 0.0162 0.024 0.0318 0.0402 0.048 0.0558]; %en m3/s
H1 = [36.3 35.7 34.5 32.7 30.3 26.6 22.4 16.9]; %en m
eta1 = [2 36 59 73 77 72 59 36]; %en%
NPSHr1 = [1.6 1.8 2.2 2.8 3.9 5.5 7.3 9.7]; %en m

% Bomba 2
Q2 = [0.0001 0.0053 0.0108 0.016 0.0212 0.0268 0.032 0.0372];
H2 = [36.3 35.7 34.5 32.7 30.3 26.6 22.4 16.9];
eta2 = [5 41 63 76 83 84 76 54];
NPSHr2 = [0.7 0.9 1.3 1.9 3 4.6 6.4 8.8];
