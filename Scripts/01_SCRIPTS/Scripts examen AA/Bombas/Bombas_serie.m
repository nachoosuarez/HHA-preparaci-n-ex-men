...
for i = 1:length(Q)
    ...
    NPSHdisp1 = [NPSHdisp1 10.1 + HA - zB];
    NPSHdisp2 = [NPSHdisp2 10.1 + HA - zB + Hb1(i)];
...
legend("Eficiencia Bomba 1", "Eficiencia Bomba 2", ...
       "location","eastoutside");

% LÍNEAS PUNTEADAS PARA EL PF
plot(Qpf, eta1_pf, 'o', 'MarkerSize', 4, ...
     "MarkerFaceColor",[1 0.5 0], "MarkerEdgeColor","none", "HandleVisibility", "off");
plot(Qpf, eta2_pf, 'o', 'MarkerSize', 4, ...
