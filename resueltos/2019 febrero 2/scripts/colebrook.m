% colebrook.m — calcula el factor de fricción de Darcy-Weisbach f
% resolviendo la ecuación de Colebrook-White (iteración cuártica, sin
% necesidad de fsolve/tablas de Moody). Entradas: R = número de Reynolds
% (>=2300), K = rugosidad relativa epsilon/D. Salida: F = factor de
% fricción, para usar en pérdidas distribuidas hf = f*(L/D)*v^2/(2g).
% Usar cuando: cualquier ejercicio de tubería a presión (bombas,
% pérdida de carga) que requiera f sin recurrir al ábaco de Moody.
