% fgv_rect.m â€” script principal de FLUJO GRADUALMENTE VARIADO (FGV) en
% canal RECTANGULAR: calcula yc (crÃ­tico, cerrado) y yn (normal, por
% fsolve), integra la ecuaciÃ³n diferencial dy/dx (rect.m) con ode23
% deteniÃ©ndose al cruzar yc (evento critico.m), y grafica el perfil de
% la superficie libre junto a las rasantes de yc/yn. Editar los DATOS DE
% ENTRADA (Q,b,S,n) y las condiciones de borde (x_ini,x_end,y_ini) segÃºn
% el enunciado â€” el signo de x_end define si se integra hacia aguas
% arriba (subcrÃ­tico) o hacia aguas abajo (supercrÃ­tico).
...
% (El tÃ­tulo original decÃ­a "Canal Trapezoidal" por copia/pegado del
% script trapezoidal â€” este script es en realidad para secciÃ³n
