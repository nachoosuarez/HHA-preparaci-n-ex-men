"""
Ejercicio 2, Parte 1 - Examen HHA 24/jul/2023
Caudal maximo de diseno de la alcantarilla, Tr=10 anios.
Cuenca en Canelones (X=494.7 km, Y=6170.9 km), flujo concentrado,
pastizales en condicion hidrologica MALA, Grupo Hidrologico C.

Replica las formulas de 'Scripts examen AA/EVENTOS EXTREMOS 2025.xlsx'
(hojas 'metodo racional' y 'NRCS'), equivalentes a la hoja 'Calculos
(grande)' de 'Eventos extremos.xlsx' (ver COMO_USAR_EVENTOS_EXTREMOS.md).
Los valores base P(3,10) (dato del enunciado, no isoyeta) y NC (Fig.
3.1.20, pastizales/condicion mala/grupo C) surgen de la solucion oficial
manuscrita adjunta al examen.
"""
import numpy as np
import math
...
L_m = 3715.0
L_km = L_m/1000
S_basin_pct = 6.5        # pendiente media de la cuenca (Tabla 3.1.4, para C)
Tr = 10                   # anios
P310 = 80.0               # mm, dato del enunciado (P(3h,10anios) en el punto de cierre)
NC = 86                   # pastizales, condicion hidrologica MALA, Grupo Hidrologico C (Fig 3.1.20)
...
print(f"Qmax racional = C*i*A/360 = {Q_racional:.3f} m3/s")
