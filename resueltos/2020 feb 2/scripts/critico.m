...
% de la ecuaciÃ³n diferencial de FGV (rect.m/fgv_rect.m) apenas el
...
% Requiere que par traiga yc en la 5ta posiciÃ³n: par=[Q b S n yc].
% (misma funciÃ³n que la de FGV_trapezoidal, reutilizada tal cual).
